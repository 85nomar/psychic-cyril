...
<div id="userSelection" class="accordion step2">
  <div class="accordion-group">
    <div class="accordion-heading"> <a href="#userSelectionDetail" data-parent="#userSelection" data-toggle="collapse" class="accordion-toggle collapsed"><strong>Ihre Auswahl:</strong> VW Golf V 1.6 Comfort <span class="small pull-right">Techische Details anzeigen</span><i class="icon-chevron-down pull-right"></i></a> </div>
...
<form>
  ...
  <script>
      ...
      //customCheckList('#additionalEquipement, #standardEquipement, #optionalEquipement');
  ...
  <div class="row-fluid" id="standardEquipement">
    <div class="span12">
      <div class="control-group">
        <label class="control-label"><strong>Serienausstattung gemäss Hersteller</strong></label>
        <div class="pull-right collapse-control">
        	<a href="#" class="showall"><i class="icon-chevron-down icon-blue"></i> alle anzeigen</a>
        	<a href="#" class="hideall hidden"><i class="icon-chevron-up icon-blue"></i> alle ausblenden</a>
        </div>      
        <div class="controls">        
        
          <!-- START STANDARD-FEATURES -->
          
          <div class="accordion" id="standardFeature">
            <div class="accordion-group">
              <div class="accordion-heading"><a class="accordion-toggle" data-toggle="collapse" data-parent="#standardFeature" href="#collapse11">Antrieb / Fahrwerk <i class="icon-collapse pull-right"></i></a></div>
              <div id="collapse11" class="accordion-body collapse">
                <div class="accordion-inner">
<div class="row-fluid">
                  <ul class="optionList span9">
                    <li> <i class="icon-select"></i>
                  ...
                  <div class="span3">
                    <a href="#" class="btn btn-small pull-right"><i class="icon-edit"></i> Ausstattung anpassen></a>
                  </div>
                  </div>
                </div>
              </div>
            ...
            <div class="accordion-group">
              <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#standardFeature" href="#collapse12">Audio / Kommunikation / Instrumente <i class="icon-collapse pull-right"></i></a></div>
...
<div class="row-fluid">
            ...
            <div class="accordion-group">
              <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#standardFeature" href="#collapse13">Komfort/Innen & Aussen <i class="icon-collapse pull-right"></i></a></div>
...
<div class="row-fluid">
            ...
            <div class="accordion-group">
              <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#standardFeature" href="#collapse14">Laden/Ziehen/Transport <i class="icon-collapse pull-right"></i></a></div>
...
<div class="row-fluid">
            ...
            <div class="accordion-group">
              <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#standardFeature" href="#collapse15">Optik/Tuning <i class="icon-collapse pull-right"></i></a></div>
...
<div class="row-fluid">
            ...
            <div class="accordion-group">
              <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#standardFeature" href="#collapse16">Sicherheit <i class="icon-collapse pull-right"></i></a></div>
...
<div class="row-fluid">
            ...
            <div class="accordion-group">
              <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#standardFeature" href="#collapse17">Diverses <i class="icon-collapse pull-right"></i></a></div>
...
<div class="row-fluid">
  ...
  <script type="text/javascript">
    ...
    $('.collapse-control a').click(function(event){
		...
		$('.collapse-control a.showall').click(function(){
			$(this).parents('.collapse-control').next().find('.collapse').not('.in').collapse('show');
		});
		$('.collapse-control a.hideall').click(function(){
			$(this).parents('.collapse-control').next().find('.collapse').collapse('hide');
		});
  });
  </script>
  <div class="row-fluid" id="optionalEquipement">
    <div class="span12">
      <div class="control-group">
        <label class="control-label"><strong>Optionale Ausstattung</strong></label>
        <div class="pull-right collapse-control">
        	<a href="#" class="showall"><i class="icon-chevron-down icon-blue"></i> alle anzeigen</a>
        	<a href="#" class="hideall hidden"><i class="icon-chevron-up icon-blue"></i> alle ausblenden</a>
        </div>
        <div class="controls">
          ...
          <div class="accordion" id="optionalFeature">
            <div class="accordion-group">
              <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#optionalFeature" href="#collapse21">Antrieb / Fahrwerk <i class="icon-collapse pull-right"></i></a></div>
...
<div class="row-fluid">
            ...
            <div class="accordion-group">
              <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#optionalFeature" href="#collapse22">Audio / Kommunikation / Instrumente <i class="icon-collapse pull-right"></i></a></div>
...
<div class="row-fluid">
            ...
            <div class="accordion-group">
              <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#optionalFeature" href="#collapse23">Komfort/Innen & Aussen <i class="icon-collapse pull-right"></i></a></div>
...
<div class="row-fluid">
            ...
            <div class="accordion-group">
              <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#optionalFeature" href="#collapse24">Laden/Ziehen/Transport <i class="icon-collapse pull-right"></i></a></div>
...
<div class="row-fluid">
            ...
            <div class="accordion-group">
              <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#optionalFeature" href="#collapse25">Optik/Tuning <i class="icon-collapse pull-right"></i></a></div>
...
<div class="row-fluid">
            ...
            <div class="accordion-group">
              <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#optionalFeature" href="#collapse26">Sicherheit <i class="icon-collapse pull-right"></i></a></div>
...
<div class="row-fluid">
            ...
            <div class="accordion-group">
              <div class="accordion-heading"> <a class="accordion-toggle" data-toggle="collapse" data-parent="#optionalFeature" href="#collapse27">Diverses <i class="icon-collapse pull-right"></i></a></div>
...
<div class="form-actions"> <a href="step2.php" class="btn btn-primary toNext">Weiter zu &laquo;<?php echo $Layout_cb->formNav[2]["title"]; ?>&raquo;</a> <a href="step6.php" class="btn toOverview">Weiter zu &laquo;<?php echo $Layout_cb->formNav[5]["title"]; ?>&raquo;</a> </div>
<?php $Layout -> end(); ?>
