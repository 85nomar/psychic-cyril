...
(function (e, t) {
    ...
    var s = {}, l = "tinymce/dom/EventUtils",
    ...
    r(l, [], function () {
        ...
        return c.fn = c.prototype = {
            ...
            init: function (e, t) {
                ...
                if (i(e)) {
                    ...
                    if (r[1]) for (a = o(e).firstChild; a;) this.add(a), a = a.nextSibling;
                    else {
        ...
        return function (e, t) {
            ...
            return {
                ...
                parse: function (t) {
                    ...
                    var h = {}, m, g, v, y, b = e.url_converter,
                ...
                serialize: function (e, n) {
                    ...
                    else for (o in e) a = e[o], a !== s && a.length > 0 && (i += (i.length > 0 ? " " : "") + o + ": " + a + ";");
                    return i
                }
            }
        }
        ...
        return function (i, c) {
            ...
            i = i || {}, i.validate = "validate" in i ? i.validate : !0, i.root_name = i.root_name || "body", d.schema = c = c || new n, d.filterNode = function (e) {
                ...
                a(s(e), function (e) {
                    var r;
                    for (r = 0; p.length > r; r++) if (p[r].name === e) return p[r].callbacks.push(n), t;
                    p.push({
                        name: e,
                        callbacks: [n]
                    })
                ...
                if (a = a || {}, h = {}, m = {}, R = l(o("script,style,head,html,body,title,meta,param"), c.getBlockElements()), I = c.getNonEmptyElements(), O = c.children, T = i.validate, F = "forced_root_block" in a ? a.forced_root_block : i.forced_root_block, P = c.getWhiteSpaceElements(), A = /^[ \t\r\n]+/, H = /[ \t\r\n]+$/, M = /[ \t\r\n]+/g, D = /^[ \t\r\n]+$/, y = new r({
                    ...
                    start: function (e, t, n) {
                        ...
                        if (i = T ? c.getElementRule(n) : {}) {
                            if (R[n] && !L) {
                                if (r = C.firstChild, r && 3 === r.type) if (o = r.value.replace(A, ""), o.length > 0) r.value = o, r = r.next;
                                    else for (a = r.next, r.remove(), r = a; r && 3 === r.type;) o = r.value, a = r.next, (0 === o.length || D.test(o)) && (r.remove(), r = a), r = a;
                                if (r = C.lastChild, r && 3 === r.type) if (o = r.value.replace(H, ""), o.length > 0) r.value = o, r = r.prev;
                                    else for (a = r.prev, r.remove(), r = a; r && 3 === r.type;) o = r.value, a = r.prev, (0 === o.length || D.test(o)) && (r.remove(), r = a), r = a
                            }
        ...
        return function (i) {
            ...
            function v(e, t, n, r) {
                function i(e, t, i) {
                    ...
                    if (s) if (s.length === X) {
                        ...
                        } else for (l = 0; s.length > l; l++) if ("attributes" === i ? I.getAttrib(e, s[l]) : N(e, s[l])) return t;
                    return t
                }
                var o = u(t),
                    a, s, l;
                if (o && e) for (s = 0; o.length > s; s++) if (a = o[s], w(e, a) && i(e, a, "attributes") && i(e, a, "styles")) {
                            if (l = a.classes) for (s = 0; l.length > s; s++) if (!I.hasClass(e, l[s])) return;
                            return a
                        }
            }
            function y(e, t, n) {
            ...
            function T(n, r, s) {
                ...
                function f(e, t) {
                    var i, o, s, l;
                    for (3 == e.nodeType && 0 === e.nodeValue.length && e[t] && (e = e[t]), i = a(e), o = 0; i.length > o; o++) for (s = 0; r.length > s; s++) if (l = r[s], !("collapsed" in l && l.collapsed !== n.collapsed) && I.is(i[o], l.selector)) return i[o];
                    return e
                }
                function p(e, t) {
                    var n;
            ...
            function R(e, n, r, i) {
                ...
                if ("all" != e.remove) for (et(e.styles, function (e, t) {
                    ...
                    }), a = I.getAttribs(r), o = 0; a.length > o; o++) if (0 !== a[o].nodeName.indexOf("_")) return K;
        ...
        return function (n) {
            ...
            function d() {
                var e, i;
                for (i = o(n.root.getEl()), r(), e = m.length; e--;) if ("toolbar" == i && m[e].id === g) return m[e].focus(), t;
                m[0].focus()
            }
            var f = n.root,
                p = n.enableUpDown !== !1,
        ...
        var c = n.DOM,
            ...
            h, m = {
                ...
                setup: function () {
                    ...
                    else for (var a = document.getElementsByTagName("script"), s = 0; a.length > s; s++) {
                            var c = a[s].src;
        ...
        return e.extend({
            recalc: function (e) {
                ...
                if (w += g.left + g.right, _ += g.top + g.bottom, l = {}, l.minW = w + (o.w - o.innerW), l.minH = _ + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
                    ...
                    var H = 0,
                        M = t.flexWidths;
                    if (M) for (d = 0; M.length > d; d++) H += M[d];
                    else H = r;
                    var D = A / H;
        ...
        return e.extend({
            ...
            value: function (e) {
                ...
                if (e !== t) {
                    ...
                    else for (a = r.settings.menu, s = 0; a.length > s; s++) i = a[s].value == e, i && (o = o || a[s].text), a[s].active = i;
                    r.text(o)
                }
                return r._super(e)
            }
...
var iframeBody = $(singleEditor +' iframe').contents().find('body');
    

$(singleEditor +' #mce_24').append('<div id="arrow" class="mce-btn arrow-right"></div>')
	$(singleEditor +' #arrow').click(function(){
		if ($(singleEditor +' #mce_24-body.mce-container-body').width() == 190)
			{$(singleEditor +' #mce_24-body.mce-container-body').animate({'width':'800px'});
			 $(singleEditor +' #arrow').removeClass('arrow-right').addClass('arrow-left');
	}else{
		$(singleEditor +' #mce_24-body.mce-container-body').animate({'width':'190px'});
...
// functionality for fucking Verkaufsvorlage Button

    $(singleEditor +' #mce_34').after(buttonHTML);
	$(singleEditor +' #mce_34').remove();

	$(document).click(function(element){
		console.log(element.target);
        $(singleEditor +' #ivan-open').click(function(e){e.preventDefault()});
		if ($(element.target).is(singleEditor +' #ivan-open')){
				if ($(singleEditor +' #vv_submenu').length < 1){$('body').append(subMenu)}else{}

			}else{

			$('#vv_submenu').remove()}

		if ($(element.target).hasClass('noTemplate') || $(element.target).hasClass('vv_sub1')){
			iframeBody.html('');
			iframeBody.add('iframe').animate({'height':'100px'});
		}
		if ($(element.target).hasClass('applyTemplate') || $(element.target).hasClass('vv_sub2')){
			iframeBody.html(htmlCodeVV);
			iframeBody.add('iframe').animate({'height':'700px'});
		}
	});

/*$('.checkbox input').on('click', function(){
    if ($('#frameOverlay').length < 1) {
    $('textarea.tinymce').after('<div id="place" style="width:100%; height:500px;"></div>');
    $('.row-fluid.langs').append('<div id="frameOverlay"><iframe id="de" src="editors_DE.php" width="450" height="650" scrolling="no" frameborder="0" style="float:left"></iframe><iframe id="fr" src="editors_FR.php" width="450" height="650" scrolling="no" frameborder="0" style="float:left"></div>');

}else{$('#frameOverlay, #place').remove()}
});
*/


$('.defaultLang iframe, .secondLang iframe').css({'height':'100px'});
...
var buttonHTMLde = '<div id="vv_conde" class="mce-widget mce-btn mce-menubtn mce-last mce-flow-layout-item" tabindex="-1" role="button" aria-haspopup="true"><button id="vv_buttonde" role="presentation" tabindex="-1">Vorlage <i class="mce-caret"></i></button></div>';
var buttonHTMLfr = '<div id="vv_confr" class="mce-widget mce-btn mce-menubtn mce-last mce-flow-layout-item" tabindex="-1" role="button" aria-haspopup="true"><button id="vv_buttonfr" role="presentation" tabindex="-1">Vorlage <i class="mce-caret"></i></button></div>';
var subMenuDE = '<div id="vv_submenu" class="de mce-container mce-panel mce-floatpanel mce-menu mce-menu-align" hidefocus="1" tabindex="-1" style="border-width: 1px;z-index: 65536;left: 1160px;top: 701px;width: 160px;" role="menu"><div id="mce_39-body" class="mce-container-body mce-stack-layout" style="width: 160px;"><div id="mce_40" class="vv_sub1 mce-menu-item mce-menu-item-expand mce-first mce-stack-layout-item" tabindex="-1" role="menuitem" aria-haspopup="true" aria-expanded="false"> <span id="mce_40-text" class="mce-text noTemplate">keine Vorlage</span></div><div id="mce_41" class="vv_sub2 mce-menu-item mce-menu-item-expand mce-stack-layout-item" tabindex="-1" role="menuitem" aria-haspopup="true" aria-expanded="false"> <span id="mce_41-text" class="mce-text applyTemplate">Verkaufsvorlage 1</span></div></div></div>'
var subMenuFR = '<div id="vv_submenu" class="fr mce-container mce-panel mce-floatpanel mce-menu mce-menu-align" hidefocus="1" tabindex="-1" style="border-width: 1px;z-index: 65536;left: 1160px;top: 701px;width: 160px;" role="menu"><div id="mce_39-body" class="mce-container-body mce-stack-layout" style="width: 160px;"><div id="mce_40" class="vv_sub1 mce-menu-item mce-menu-item-expand mce-first mce-stack-layout-item" tabindex="-1" role="menuitem" aria-haspopup="true" aria-expanded="false"> <span id="mce_40-text" class="mce-text noTemplate">keine Vorlage</span></div><div id="mce_41" class="vv_sub2 mce-menu-item mce-menu-item-expand mce-stack-layout-item" tabindex="-1" role="menuitem" aria-haspopup="true" aria-expanded="false"> <span id="mce_41-text" class="mce-text applyTemplate">Verkaufsvorlage 1</span></div></div></div>'
var htmlCodeVV = '<div id="vv_container"><div id="vv_header"></div><div id="vv_content"><h1>Produktename</h1>sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.<h2>Detail 1</h2> sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut. <h2>Detail 2</h2>sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut. </div><div id="vv_footer"><br /><br />consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut.</div></div>';
var iframeBodyDE = $('.defaultLang iframe').contents().find('body');
var iframeBodyFR = $('.secondLang iframe').contents().find('body');
    
// arrow functionality DE form
arrowContainer.append('<div id="arrow" class="mce-btn arrow-down secondLang hidden"></div>');
$(de + ' #arrow').on('click', function(){
    if ($(this).hasClass('arrow-down')){
        $(heightAnimation).animate({'height':'71px'});
...
$(fr + ' #arrow').on('click', function(){
    if ($(this).hasClass('arrow-down')){
        $(heightAnimationfr).animate({'height':'71px'});
        $(this).removeClass('arrow-down').addClass('arrow-up');
    }else{
    ...
    var deLastButton = $(de+ ' .mce-tinymce .mce-container-body .mce-container:eq(1) .mce-container-body .mce-toolbar .mce-container-body div:last');
    var frLastButton = $(fr+ ' .mce-tinymce .mce-container-body .mce-container:eq(1) .mce-container-body .mce-toolbar .mce-container-body div:last');

    deLastButton.after(buttonHTMLde);
    frLastButton.after(buttonHTMLfr);

    $('#vv_buttonde, #vv_buttonfr').click(function(e){
        e.preventDefault();
    });
...
//insert submenu
    $(document).click(function(element){
        $('#vv_buttonde, #vv_conde').on('click', function(){
            if ($('#vv_submenu.defaultLang').length < 1){
            $('#DualEditorDE').append(subMenuDE);
        }
        });
        $('#vv_buttonfr, vv_confr').on('click', function(){
                if ($('#vv_submenu.secondLang').length < 1){
            $('#DualEditorFR').append(subMenuFR);
        }
        });

        $(document).click(function(element){
            if($(element.target).is('#vv_buttonfr') || $(element.target).is('#vv_buttonde')){}else{$('#vv_submenu').remove()}

        if ($(element.target).is('.defaultLang .noTemplate') || $(element.target).hasClass('vv_sub1')){
            iframeBodyDE.html('');
            iframeBodyDE.add('.defaultLang iframe').animate({'height':'100px'});
            }

        if ($(element.target).is('.defaultLang .applyTemplate') || $(element.target).hasClass('vv_sub2')){
            iframeBodyDE.html(htmlCodeVV);
            iframeBodyDE.add('.defaultLang iframe').animate({'height':'700px'});
            }

        if ($(element.target).is('.secondLang .noTemplate') || $(element.target).hasClass('vv_sub1')){
            iframeBodyFR.html('');
            iframeBodyFR.add('.secondLang iframe').animate({'height':'100px'});
            }

        if ($(element.target).is('.secondLang .applyTemplate') || $(element.target).hasClass('vv_sub2')){
            iframeBodyFR.html(htmlCodeVV);
            iframeBodyFR.add('.secondLang iframe').animate({'height':'700px'});
            }
...
/*
    if ($('.checkbox input').is(':checked') == true){
        $('.de').removeClass('span12').addClass('span6');
            $('.fr-row').attr('style', 'visibility:visible !important');
            $('.fr').attr('style', 'display:block!important')
            $('.de #arrow').css({'display':'block'});
        }else{
            $('.de').removeClass('span6').addClass('span12');
            $('.fr-row').attr('style', 'visibility:hidden !important');
            $('.fr').attr('style', 'display:none !important');
            $('.de #arrow').css({'display':'none'});
        }
    $('.checkbox input, #swissIcons').click(function(){
        if ($('.de').is('.span12')){
...
$('a.accordion-toggle').on('click', function(){
    var icon = $('#accordion2.step2 i');
    if(icon.is('.icon-chevron-down')){
