...
$('#mce_26').append('<div id="arrow" class="mce-btn">></div>')
	$('#arrow').click(function(){
		if ($('#mce_26-body.mce-container-body').width() == 77)
			{$('#mce_26-body.mce-container-body').animate({'width':'640px'});
			 $('#arrow').text('<')
	}else{
		$('#mce_26-body.mce-container-body').animate({'width':'77px'});
		$('#arrow').text('>')
