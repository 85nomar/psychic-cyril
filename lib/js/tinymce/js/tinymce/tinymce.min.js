...
//insert submenu
    $(document).click(function(element){
        $('#vv_buttonde').on('click', function(){
            if ($('#vv_submenu.de').length < 1){
            $('body').append(subMenuDE);
        }
        });
        $('#vv_buttonfr').on('click', function(){
                if ($('#vv_submenu.fr').length < 1){
            $('body').append(subMenuFR);
        }
        });
