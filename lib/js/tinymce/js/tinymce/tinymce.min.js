...
$('#mce_27').append('<div id="arrow" class="mce-btn arrow-right"></div>')
	$('#arrow').click(function(){
		if ($('#mce_27-body.mce-container-body').width() == 190)
			{$('#mce_27-body.mce-container-body').animate({'width':'800px'});
			 $('#arrow').removeClass('arrow-right').addClass('arrow-left');
	}else{
		$('#mce_27-body.mce-container-body').animate({'width':'190px'});
