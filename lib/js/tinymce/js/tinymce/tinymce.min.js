...
var buttonHTMLde = '<div id="vv_conde" class="mce-widget mce-btn mce-menubtn mce-last mce-flow-layout-item" tabindex="-1" role="button" aria-haspopup="true"><button id="vv_buttonde" role="presentation" tabindex="-1">Verkaufsvorlage <i class="mce-caret"></i></button></div>';
var buttonHTMLfr = '<div id="vv_confr" class="mce-widget mce-btn mce-menubtn mce-last mce-flow-layout-item" tabindex="-1" role="button" aria-haspopup="true"><button id="vv_buttonfr" role="presentation" tabindex="-1">Verkaufsvorlage <i class="mce-caret"></i></button></div>';
